...
namespace BAL_AMCPE
{
    public class InstructionTemplates
    {
        ...
        /// ///////////////////
        /// </summary>
        public InstructionTemplate obj;
        public int TotalPages { get; set; }


        public List<InstructionTemplate> GetEmailTemplates()
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.InstructionTemplates.Where(a => a.IsDeleted == false).ToList();
            }
        }
        public DAL_AMCPE.InstructionTemplate GetDocTemplateByID(int id)
        {
            id = Convert.ToInt16(id);
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.InstructionTemplates.Where(a => a.Id == id).SingleOrDefault();
            }
        }

        public List<DAL_AMCPE.GetInstructionTemplateByNames_Result> GetInstructionTemplateByNames(string names)
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.GetInstructionTemplateByNames(names).ToList();
            }
        }
        ...
        public string GetDocTemplatePathByID(int id)
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.InstructionTemplates.Where(a => a.Id == id).Select(c => c.TemplatePath).SingleOrDefault().ToString();
            }
        }
        ...
        public List<InstructionTemplate> GetDocTemsplateById(int id)
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                if (id == 0)
                    return DB.InstructionTemplates.Where(a => a.IsDeleted == false).OrderBy(a => a.TemplateName).ToList();
                else
                    return DB.InstructionTemplates.Where(a => a.IsDeleted == false && a.Id == id).OrderBy(a => a.TemplateName).ToList();
            }
        }
        public List<DAL_AMCPE.InstructionTemplate> GetAllDocTemplates()
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.InstructionTemplates.Where(a => a.IsDeleted == false).OrderBy(a => a.TemplateName).ToList();
        ...
        public List<InstructionTemplate> GetDocumentTemplatesList(int pageIndex, int pageSize, string sortExpression, string searchKeyword, int id)
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                if (searchKeyword == "")
                { return DB.InstructionTemplates.ToList(); }
                else { return DB.InstructionTemplates.Where(d => d.TemplateName == searchKeyword).ToList(); }
            }
        }
        ...
        public InstructionTemplate GetDocumentTemplateByID(int id)
        {
            using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
            {
                return DB.InstructionTemplates.Where(a => a.IsDeleted == false && a.Id == id).SingleOrDefault();
            }
        }
        ...
        public int Save(DAL_AMCPE.InstructionTemplate obj)
        {
            try
            {
                using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
                {
                    ...
                    else
                    {
                        if (obj.Id == 0)
                        {
                            DB.InstructionTemplates.AddObject(obj);
                        }
                        else
                        {
                            DB.InstructionTemplates.Attach(obj);
        ...
        public bool UpdateTemplate(DAL_AMCPE.InstructionTemplate ob)
        {
            try
            {
                using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
                {
                    DB.InstructionTemplates.Attach(ob);
        ...
        public bool DeleteTemplate()
        {
            try
            {
                using (AMCPatientEmailEntities DB = new AMCPatientEmailEntities())
                {
                    DB.InstructionTemplates.DeleteObject(obj);
