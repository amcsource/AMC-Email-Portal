<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true"
    CodeFile="AllSentEmails.aspx.cs" Inherits="Emails_AllSentEmails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <div id="search">
        ...
        <div style="width:50%; float: right;">
            <span class="dropdown">
                <asp:DropDownList ID="ddlUserName" runat="server" Width="100px">
                </asp:DropDownList>
                <asp:DropDownList ID="ddlEmailTemplate" runat="server" Width="150px">
                </asp:DropDownList>
            </span>
            <span class="ptNumber">
                <asp:TextBox ID="txtPatientNumber" runat="server" placeholder="Enter patient #"></asp:TextBox>
                <asp:Button ID="btnPatientNumber" runat="server" Text="Filter" OnClick="btnSearch_Click" />
            </span>
        </div>
    </div>
    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnItemDataBound="rptList_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="View" runat="server" PostBackUrl='<%# "SendEmail.aspx?action=view&EmailId=" + Eval("Id") %>'
                        ToolTip="View"><i class="fa fa-eye"></i></asp:LinkButton>
                    <asp:LinkButton ID="Send" runat="server" PostBackUrl='<%# "SendEmail.aspx?action=resend&EmailId=" + Eval("Id") %>'
                        ToolTip="Resend"><i class="fa fa-location-arrow"></i></asp:LinkButton>
                    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl='<%# "SendEmail.aspx?action=forward&EmailId=" + Eval("Id") %>'
                        ToolTip="Forward"><i class="fa fa-mail-forward"></i></asp:LinkButton>
