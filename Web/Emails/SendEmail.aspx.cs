...
public partial class Emails_SendEmail : System.Web.UI.Page
{
                ...
                if (emailHasAttachments)
                {
                    ...
                    if (hdnPromptFileUrl.Value != "" && hdnPromptFileName.Value != "")
                    {
                        ...
                        for (int i = 0; i < length; i++)
                        {
                            ...
                            {
                                File.Copy(Path.Combine(fileUrls[i], fileNames[i]), Path.Combine(targetPath, fileNames[i]), true);
                                attachmentUrls.Add(Path.Combine(targetPath, fileNames[i]));
                            }
                        }
                    }
                }
