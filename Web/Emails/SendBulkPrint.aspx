<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="SendBulkPrint.aspx.cs" Inherits="SendBulkPrint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <h2 class="mainheading">Bulk Print</h2>
    ...
    <div id="filter">
        ...
        <div class="pagesize">
            <asp:DropDownList ID="ddlPatientType" runat="server" Width="200px">
                ...
                <asp:ListItem Text="12 Month Path Post" Value="12 Month Path Post" />
                <asp:ListItem Text="12 Month Path Post DHEA" Value="12 Month Path Post DHEA" />
            </asp:DropDownList>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="width: 25%;">Patient Name/Number
                        </th>
                        <th scope="col" style="width: 15%;">Source
                        </th>
                        <th scope="col" style="width: 15%;">Stage
                        </th>
                        <th scope="col" style="width: 20%;">Email
                        </th>
                        <th scope="col" style="width: 10%;">Purpose
                        </th>
                        <th scope="col" style="width: 10%;">Phone
                        </th>
                    </tr>
                </thead>
                <tbody class="records">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    ...
                    <asp:HiddenField ID="hdnXSORecID" runat="server" Value='<%# Eval("XSORecID") %>' />
                    <asp:HiddenField ID="hdnPresType" runat="server" Value='<%# Eval("PresType") %>' />
                    <asp:Literal ID="ltlpatientName" runat="server" Text='<%# Eval("PatientName") %>'></asp:Literal>
                    /
                    <asp:Literal ID="ltlpatientNumber" runat="server" Text='<%# Eval("PatientNumber") %>'></asp:Literal>
                </td>
                <td>
                    <%# Eval("Source") %>
                </td>
    ...
    <div class="formdata" id="dvSendEmail" runat="server">
        <div class="formbuttons">
            <asp:Button ID="btnSend" runat="server" Text="Print" CssClass="submit-button btnSend" OnClick="btnSend_Click" />
        </div>
    </div>
    ...
    <asp:HiddenField ID="hdnPresType" runat="server" />
