...
public partial class AddEditTagCategory : System.Web.UI.Page
{
    ...
    private void GetCategoryById(int id)
    {
        ...
        tc.obj = tc.GetEmailTemplateCategoryByID(id);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (categoryId == 0)
        {
            tc.obj = new DAL_AMCPE.EmailTemplateCategory();
            tc.obj.CreatedBy = Convert.ToString(Session["UserId"]);
            tc.obj.CreatedOn = DateTime.Now;
        }
        else
        {
            tc.obj = tc.GetEmailTemplateCategoryByID(categoryId);
        ...
        {
            Session["dataction"] = "s";
            Response.Redirect("EmailTemplateCategory.aspx");
        }
    }
