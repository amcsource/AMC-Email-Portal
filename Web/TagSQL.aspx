<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true"
    CodeFile="TagSQL.aspx.cs" Inherits="TagSQL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <div class="formdata">
        <div class="form-elements">
            <label for="name">
                Choose Tag Category</label>
            <asp:DropDownList ID="ddlTagCategory" runat="server" CssClass="inputselect" AutoPostBack="true"
                OnSelectedIndexChanged="ddlTagCategory_SelectedIndexChanged">
            </asp:DropDownList>
        </div>
    </div>
    <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnItemDataBound="rptList_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:LinkButton ID="Edit" runat="server" PostBackUrl='<%# "AddEditTagSQL.aspx?Id=" + Eval("Id") %>'
