...
public partial class EmailTemplateCategory : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        var data = tc.GetEmailTemplateCategories();
        if (data.Count > 0)
        {
    ...
    protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            BAL_AMCPE.EmailTemplateCategory tc = new BAL_AMCPE.EmailTemplateCategory();
            tc.obj = tc.GetEmailTemplateCategoryByID(Convert.ToInt32(e.CommandArgument));
